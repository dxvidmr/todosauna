-- Exponer fecha de alta del colaborador para "Mi participacion"

drop function if exists public.rpc_bootstrap_session(uuid);

create function public.rpc_bootstrap_session(
