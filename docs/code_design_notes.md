...
We use the project semantic button variants on top of Bootstrap's structural `.btn` class.
...
For example, `<a class="btn btn-accent" href="https://example.com">Link</a>`.
...
For example, `<a class="btn btn-accent" href="#" role="button" data-toggle="modal" data-target="#exampleModal">Link</a>`.
