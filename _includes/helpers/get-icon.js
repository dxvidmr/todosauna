...
function getIcon(objectTemplate,objectFormat,svgType) {
    ...
    if (svgType == "thumb") {
        // svg sprite as thumb
        return '<svg class="bi text-ink img-fluid" fill="currentColor" role="img"><title>' + iconTitle + '</title><use xlink:href="{{ "/assets/css/cb-icons.svg" | relative_url }}#' + iconId + '"/></svg>';
