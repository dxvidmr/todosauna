...
const outDir = path.join(repoRoot, "assets", "data", "pasajes");
const warningsDir = path.join(repoRoot, "docs", "generated");
const jsonPath = path.join(outDir, "fuenteovejuna.json");
const warningsPath = path.join(warningsDir, "pasajes_fuenteovejuna_warnings.md");
